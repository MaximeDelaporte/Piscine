...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/11 15:27:53 by madelapo          #+#    #+#             */
/*   Updated: 2017/09/11 16:39:05 by madelapo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((vert == 0 && hor == 0) || (vert == y - 1 && hor == 0))
	{
		ft_putchar('A');
	}
	else if ((hor == x - 1 && vert == y - 1) || (hor == x - 1 && vert == 0))
	{
		ft_putchar('C');
	}
	else
